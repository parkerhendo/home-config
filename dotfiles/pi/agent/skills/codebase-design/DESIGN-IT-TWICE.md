...
Use both [SKILL.md](SKILL.md) vocabulary and CONTEXT.md vocabulary so each design names things consistently with the architecture language and the project's domain language.
